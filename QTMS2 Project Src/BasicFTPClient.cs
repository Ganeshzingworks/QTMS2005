...
namespace QTMS
{
    class BasicFTPClient
    {
        ...
        {
            Username = GlobalVariables.FTPUsername;
            Password = GlobalVariables.FTPPassword;
            Port = GlobalVariables.FTPPort;
            Host = GlobalVariables.FTPHost;
        }
        ...
        public Uri BuildServerUri(string Path)
        {
        ...
        public bool DeleteFile(string fileName)
        {
            ...
            FtpWebRequest requestFileDelete = (FtpWebRequest)WebRequest.Create(BuildServerUri(fileName));
