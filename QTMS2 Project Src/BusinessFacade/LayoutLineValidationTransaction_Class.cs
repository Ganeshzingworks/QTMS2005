...
{
    public class LayoutLineValidationTransaction_Class
    {
        #region Varibles
        private long Id;
        ...
        #endregion
        #region Functions
        public DataSet Select_LayoutLineValidationTransaction()
        {
            try
            {
                DataSet ds = new DataSet();
                ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "STP_SELECT_tblLayoutLineValidationTransaction");
                return ds;
            }
            catch (Exception ex)
            {
        ...
        public bool Insert_LayoutLineValidationTransaction()
        {
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "STP_INSERT_tblLayoutLineValidationTransaction", myparam);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Update_LayoutLineValidationTransaction()
        {
            try
            {
                ...
                SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "STP_Update_tblLayoutLineValidationTransaction", myparam);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool Delete_LayoutLineValidationTransaction()
        {
            try
            {
                ...
                myparam[0] = ModHelper.CreateParameter("@Id", SqlDbType.BigInt, 8, ParameterDirection.Input, Id);
                SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "STP_Delete_tblLayoutLineValidationTransaction", myparam);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public DataSet Select_All_Record_tblLayoutLineValidationTransaction()
        {
            try
            {
                DataSet ds = new DataSet();
                ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "SP_Select_All_tblLayoutLineValidationTransaction");
                return ds;
            }
            catch (Exception ex)
            {
        ...
        public DataSet SelectAll_LayoutLineTransactionMasterByLineDescriptionId(long lineDescriptionId)
        {
            try
            {
                ...
                SqlParameter[] myparam = new SqlParameter[1];
                myparam[0] = ModHelper.CreateParameter("@LayoutLineDescriptionId", SqlDbType.BigInt, 8, ParameterDirection.Input, lineDescriptionId);
                ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "STP_SelectAll_tblLayoutLineValidationTransaction_By_LayoutLineDescriptionId", myparam);
                return ds;
            }
            catch (Exception ex)
            {
