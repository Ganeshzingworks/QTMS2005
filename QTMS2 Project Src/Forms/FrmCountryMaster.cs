...
namespace QTMS.Forms
{
	...
	/// </summary>
	public class FrmCountryMaster : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // txtCountryName
            // 
            this.txtCountryName.BackColor = System.Drawing.Color.WhiteSmoke;
            this.txtCountryName.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.txtCountryName.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtCountryName.Location = new System.Drawing.Point(148, 86);
            this.txtCountryName.MaxLength = 50;
            this.txtCountryName.Name = "txtCountryName";
            this.txtCountryName.Size = new System.Drawing.Size(280, 22);
            ...
            this.txtSearch.Location = new System.Drawing.Point(11, 39);
            ...
            this.toolStripLabel1.Text = "Country Master";
            // 
        ...
        private static Forms.FrmCountryMaster FrmCountryMaster_Obj = null;
        public static Forms.FrmCountryMaster GetInstance()
        {
            if (FrmCountryMaster_Obj  == null)
            {
                FrmCountryMaster_Obj = new Forms.FrmCountryMaster();
            }
            return FrmCountryMaster_Obj;
        }
        ...
        public void Bind_List()
        {
            try
            {
                ...
                DtList = CountryMaster_Class_obj.Select_CountryMaster();

                List.DataSource = DtList;
                List.DisplayMember = "Country";
                List.ValueMember = "CountryID";
            }
            catch (Exception ex)
            {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Enter Country Name", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtCountryName.Focus();
                    return;
                }
                if (Modify)
                {
                    CountryMaster_Class_obj.countryname = txtCountryName.Text.Trim();
                    CountryMaster_Class_obj.countryid = Convert.ToInt32(List.SelectedValue.ToString());
                    if (CountryMaster_Class_obj.countryid == 0)
                    {
                    ...
                    {
                        bool b = CountryMaster_Class_obj.Update_CountryMaster();
                        if (b == true)
                        {
                ...
                {
                    CountryMaster_Class_obj.countryname = txtCountryName.Text.Trim();
                    bool b = CountryMaster_Class_obj.Insert_CountryMaster();
                    if (b == true)
                    {
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (CountryMaster_Class_obj.countryid != 0)
                {
                    ...
                    {
                        CountryMaster_Class_obj.countryid = Convert.ToInt32(List.SelectedValue.ToString());
                        bool b = CountryMaster_Class_obj.Delete_CountryMaster();
                        if (b == true)
                        {
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            DtList.DefaultView.RowFilter = "Country like  '" + searchString + "%'";
            List.DataSource = DtList;
