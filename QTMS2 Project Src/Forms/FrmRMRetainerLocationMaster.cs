...
{
    public partial class FrmRMRetainerLocationMaster : Form
    {
        DataSet dsList = new DataSet();
        public FrmRMRetainerLocationMaster()
        {
            InitializeComponent();
        }

        private static FrmRMRetainerLocationMaster FrmRMRetainerLocationMaster_Obj = null;
        public static FrmRMRetainerLocationMaster GetInstance()
        {
            if (FrmRMRetainerLocationMaster_Obj == null)
            {
                FrmRMRetainerLocationMaster_Obj = new FrmRMRetainerLocationMaster();
            }
            return FrmRMRetainerLocationMaster_Obj;
        }
        ...
        public void Bind_List()
        {
            try
            {
                ...
                dsList = RetainerLocation_Class_Obj.Select_RMRetainerLocation();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Modify == false)
                {
                    ...
                    RetainerLocation_Class_Obj.createdby = FrmMain.LoginID;
                    RetainerLocation_Class_Obj.modifiedby = FrmMain.LoginID;
                    bool b = RetainerLocation_Class_Obj.Insert_RMRetainerLocation();
                    if (b == true)
                    {
                ...
                else
                {
                    ...
                    bool b = RetainerLocation_Class_Obj.Update_RMRetainerLocation();
                    if (b == true)
                    {
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (RetainerLocation_Class_Obj.locationid > 0)
                {
                    ...
                    {
                        bool b = RetainerLocation_Class_Obj.Delete_RMRetainerLocation();
                        if (b == true)
                        {
