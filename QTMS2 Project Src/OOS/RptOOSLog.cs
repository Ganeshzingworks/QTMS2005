...
namespace QTMS.OOS {
    ...
    public class RptOOSLog : ReportClass {
    ...
    public class CachedRptOOSLog : Component, ICachedReport {
        
        public CachedRptOOSLog() {
        }
