...
namespace QTMS.Tools
{
    ...
    public class NotifyWindow : System.Windows.Forms.Form
    {
        ...
        public NotifyWindow()
        {
            ...
            // Default values set by vijay tomake
            BackgroundStyle = BackgroundStyles.VerticalGradient;
            ClockState = ClockStates.None;
            ...
            TitleFont = new Font("Trebuchet MS", 9, FontStyle.Regular);
        ...
        public void Notify()
        {
            ...
            //SetWindowPos(Handle, HWND_TOPMOST, 530, 171, ActualWidth, 0, SWP_NOACTIVATE);
        ...
        protected virtual void drawBorder(Graphics fx)
        {
            ...
            // By Vijay Tomake
            fx.DrawRectangle(Pens.Black, 0, 0, Width-1, ActualHeight-1);         
        }
