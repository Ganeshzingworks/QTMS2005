...
namespace QTMS.Reports {
    ...
    public class AOC_Report : ReportClass {
    ...
    public class CachedAOC_Report : Component, ICachedReport {
        
        public CachedAOC_Report() {
        }
