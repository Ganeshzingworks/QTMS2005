...
namespace QTMS.Reports {
    ...
    public class FG_Report : ReportClass {
    ...
    public class CachedFG_Report : Component, ICachedReport {
        
        public CachedFG_Report() {
        }
