...
namespace QTMS.Reports {
    ...
    public class PMDue_Report : ReportClass {
    ...
    public class CachedPMDue_Report : Component, ICachedReport {
        
        public CachedPMDue_Report() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PMDue_Report rpt = new PMDue_Report();
            rpt.Site = this.Site;
            return rpt;
        }
