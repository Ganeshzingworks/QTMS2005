...
namespace QTMS.Reports {
    ...
    public class RMDue_Report : ReportClass {
    ...
    public class CachedRMDue_Report : Component, ICachedReport {
        
        public CachedRMDue_Report() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RMDue_Report rpt = new RMDue_Report();
            rpt.Site = this.Site;
            return rpt;
        }
