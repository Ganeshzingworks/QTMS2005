...
namespace QTMS.Reports {
    ...
    public class RMLabelValidity : ReportClass {
        
        public RMLabelValidity() {
        }
        
        public override string ResourceName {
            get {
                return "RMLabelValidity.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRMLabelValidity : Component, ICachedReport {
        
        public CachedRMLabelValidity() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RMLabelValidity rpt = new RMLabelValidity();
            rpt.Site = this.Site;
            return rpt;
        }
