...
namespace QTMS.Reports {
    ...
    public class RMPending_Report : ReportClass {
        
        public RMPending_Report() {
        }
        
        public override string ResourceName {
            get {
                return "RMPending_Report.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRMPending_Report : Component, ICachedReport {
        
        public CachedRMPending_Report() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RMPending_Report rpt = new RMPending_Report();
            rpt.Site = this.Site;
            return rpt;
        }
