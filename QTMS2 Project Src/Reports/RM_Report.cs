...
namespace QTMS.Reports {
    ...
    public class RM_Report : ReportClass {
    ...
    public class CachedRM_Report : Component, ICachedReport {
        
        public CachedRM_Report() {
        }
